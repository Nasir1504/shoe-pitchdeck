...
//styles
import "./problem-content-card.scss";
...
import Ribbon3 from '../../../img/problem/ribbon3.png';
import Ribbon4 from '../../../img/problem/ribbon4.png';


export default function ProblemContentCard({
    BGImage,
    CardPosition,
    nameTag1,
    nameTag2,
    ...
    return (
        ...
        <div className="problem-content-card-container" >
